...
import (
	"github.com/create-go-app/net_http-go-template/app/api/airlines"
	"github.com/create-go-app/net_http-go-template/app/api/airports"
	"github.com/create-go-app/net_http-go-template/app/api/locations"
...
func PublicRoutes(router *chi.Mux) {
	...
	//Aviation Tax
	router.Get("/api/v1/tax", airlines.GetAviationTax)
	router.Get("/api/v1/tax/count", airlines.GetNumberOfAviationTax)
